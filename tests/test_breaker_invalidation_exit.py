...
def _active_breaker_trade() -> ResearchTrade:
...
def test_breaker_exits_on_confirmed_zone_invalidation_before_fail_safe_stop():
    repository = _RepositoryStub()
    monitor = TradeMonitor(repository)
    trade = _active_breaker_trade()
...
def test_breaker_wick_below_zone_does_not_invalidate_without_close_below():
    repository = _RepositoryStub()
    monitor = TradeMonitor(repository)
    trade = _active_breaker_trade()
